...
public class JavaKeyStoreUnitTest {
	...
	@Test
	public void givenLoadedKeyStore_whenSetCertificateEntry_thenSizeIsOneAndGetCertificateEntryNotNull()
			throws Exception {
		keyStore.createEmptyKeyStore();
		keyStore.loadKeyStore();
	...
	private X509Certificate generateSelfSignedCertificate(KeyPair keyPair) throws CertificateException, IOException,
		...
		GeneralNameInterface dnsName = new DNSName("google.com");
		...
		// Since the SHA1withRSA provider may have a different algorithm ID to what we
		// think it should be,
